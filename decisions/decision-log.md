...
| DEC-CP05-10 | S1에서는 기존 FUND DB를 변경하지 않고 요청 DB의 단방향 Relation을 사용하며, 상세 Status·View Filter·Form 질문과 실제 FUND 기반 Rollup 검증은 P2·P4 또는 승인된 TEST Record 검증으로 유예 | 기존 운영 자산 보호와 Fast Skeleton 검증을 동시에 충족; S1 판정은 `PARTIAL_WITH_SAFE_CONSTRAINTS` | DECIDED | 사용자 승인 제약·Codex 실행 결과 | S1,P2,P4 | 2026-07-23 |
