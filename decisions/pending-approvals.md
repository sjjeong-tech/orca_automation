...
|---|---|---|---|---|
| AG-01 | CP-05 목표 재정의 | APPROVAL_REQUIRED_NOW | P0 승인 | P0 |
| AG-02 | 상위 Record 단위 | APPROVAL_REQUIRED_NOW | P1 전 | P1 |
| AG-03 | 동일 조합 업무 분리 기준 | APPROVAL_REQUIRED_NOW | P1 전 | P1 |
| AG-04 | 2개 DB MVP | APPROVAL_REQUIRED_NOW | P1 전 | P1 |
| AG-05 | 조합 Master DB | APPROVAL_REQUIRED_NOW | P1 전 | P1 |
| AG-06 | 알림 Queue DB | APPROVAL_REQUIRED_NOW | P1 전 | P1,P4 |
...
| AG-20 | Pilot 대상 조합 | APPROVAL_REQUIRED_BEFORE_PILOT | Pilot 전 | B2 |
