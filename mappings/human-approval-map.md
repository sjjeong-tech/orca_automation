...
| HA-05 기관 예외 | UN-10/14, AO-02/04/11/12, AS-01/06/08/09 | TS-WAIT/REWORK | 대응 경로 | TS-WAIT | Blocker·EV-RESPONSE | 과거 사례 제안만 |
| HA-06 보완 경로 | OT-P08-01/02/03 | TS-REWORK | 수정·재요청 진행 | TS-REWORK | 보완 사유·처분 | GP 재요청 대체 금지 |
| HA-07 결과 전달 | 각 Process 결과 OT | TS-ACTIVE | 전달 허용 | TS-REWORK | EV-RESULT/SCAN/DELIVERY | 수신자 최종 확인 금지 |
| HA-08 요청 완료 | 모든 요청 | RQ-ACTIVE | RQ-DONE | RQ-ACTIVE/REWORK | RC-01~06·승인자·일시 | 승인자 대체 금지 |
