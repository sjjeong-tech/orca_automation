...
| 요청 DB | 요청일·목표일·상태 | P2_MODEL_PROPOSED | AG-P2/Build | 7개 상태 승인·적용 대기 |
...
| Task DB | 상태·담당자·Actor·목표일 | P2_MODEL_PROPOSED | AG-P2/P3 | 6개 상태·Actor Contract 승인 대기 |
| Task DB | 다음 Action·Blocker·완료조건 | P2_MODEL_PROPOSED | AG-P2/P3 | Text 기반 수동 Contract |
| Task DB | 완료증빙·비고 | P2_MODEL_PROPOSED | AG-P2/P3 | Evidence ID·경로 규칙 승인 대기 |
