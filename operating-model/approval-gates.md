...
|---|---|---|---|---|---|---|---|---|---|
| AG-01 | CP-05 목표 재정의 | Gap 선해소 / Control Plane 전환 | Control Plane, Gap은 Cross-cutting | P0 승인 | 후속 Roadmap 불명확 | 사용자·정상준 | APPROVAL_REQUIRED_NOW | P0 | MD-01~10 |
| AG-02 | 상위 Record 단위 | 조합 / 업무 건 / 요청 | 조합별 업무 건 | P1 전 | DB 핵심 Relation 미정 | 사용자·정상준 | APPROVAL_REQUIRED_NOW | P1 | MD-01 |
| AG-03 | 동일 조합 업무 분리 | 통합 / Process별 / 요청별 | 독립 완료조건 업무별 | P1 전 | 중복·상태 충돌 | 사용자·정상준 | APPROVAL_REQUIRED_NOW | P1 | MD-01 |
| AG-04 | 2개 DB MVP | 단일 DB / 업무+Task / 3개 이상 | 업무+Task 2개 | P1 전 | Schema 범위 미정 | 사용자·정상준 | APPROVAL_REQUIRED_NOW | P1 | MD-01,02 |
| AG-05 | 조합 Master DB | 즉시 / Pilot 후 / 미사용 | Pilot 후 판단 | P1 전 | Relation·중복 기준 미정 | 사용자·정상준 | APPROVAL_REQUIRED_NOW | P1 | MD-01 |
| AG-06 | 알림 Queue DB | 별도 DB / Task 속성 / 외부 로그 | MVP는 Task 속성 | P1 전 | 알림 Audit 구조 미정 | 사용자·정상준 | APPROVAL_REQUIRED_NOW | P1,P4 | MD-02,06 |
...
| AG-10 | Atomic Task 생성 범위 | 전체 / Milestone / 혼합 | Pilot은 혼합 | Build 전 | Task 수·운영부하 미정 | 사용자·정상준 | APPROVAL_REQUIRED_BEFORE_BUILD | P3 | MD-02,05 |
...
| AG-20 | Pilot 대상 조합 | 신규 1건 / 복수 / 과거 재현 | 신규 1건+재현 1건 | Pilot 전 | 대표성 미정 | 사용자·정상준 | APPROVAL_REQUIRED_BEFORE_PILOT | B2 | MD-07 |
...
| 상태 | 수 |
|---|---:|
| APPROVAL_REQUIRED_NOW | 6 |
| APPROVAL_REQUIRED_BEFORE_BUILD | 13 |
