...
공식 Source에서 확인되는 투자기구 유형 분류 지점과 아직 확인되지 않은 조합 유형별 차이를 구분한다. 개투·벤투·신투·민법의 명칭이나 차이를 Source 없이 확정하지 않는다.
...
`N-06/6.3`과 `N-08/E2E-03`은 구조·연결을 보조할 뿐 개투·벤투·신투·민법의 상세 차이를 제공하지 않는다.

## 4. 유형별 근거 Matrix

| 조합 유형 | 관련 Process·Task | 확인된 차이 | Source | 상태 | 비고 |
|---|---|---|---|---|---|
| 개투 | 03 `UN-04`~`UN-06` 후보 | 개투 명칭과 유형별 차이를 직접 확인하지 못함 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN | 인터뷰·추가 공식 Source 확인 필요 |
| 벤투 | 03 `UN-04`~`UN-06` 후보 | 벤투 명칭과 유형별 차이를 직접 확인하지 못함 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN | 인터뷰·추가 공식 Source 확인 필요 |
| 신투 | 03 `UN-04`~`UN-06` 후보 | 신투 명칭과 유형별 차이를 직접 확인하지 못함 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN | 인터뷰·추가 공식 Source 확인 필요 |
| 민법 | 03 `UN-04`~`UN-06` 후보 | 민법 명칭과 유형별 차이를 직접 확인하지 못함 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN | 인터뷰·추가 공식 Source 확인 필요 |
...
| FT-01 | 개투로 분류되는 경우 | 03 `UN-04`~`UN-06` 후보 | DECISION | 적용 차이 확인 필요 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN |
| FT-02 | 벤투로 분류되는 경우 | 03 `UN-04`~`UN-06` 후보 | DECISION | 적용 차이 확인 필요 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN |
| FT-03 | 신투로 분류되는 경우 | 03 `UN-04`~`UN-06` 후보 | DECISION | 적용 차이 확인 필요 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN |
| FT-04 | 민법으로 분류되는 경우 | 03 `UN-04`~`UN-06` 후보 | DECISION | 적용 차이 확인 필요 | 지정 공식 Source 내 직접 근거 없음 | UNKNOWN |

## 6. Input 차이

- `UN-04`의 공통 Input이 조합·GP 정보라는 사실만 확인된다.
- 개투·벤투·신투·민법별 추가 Input은 확인되지 않아 모두 `UNKNOWN`이다.

## 7. 문서 차이

- `UN-05`에서 유형별 승인공문 또는 근거자료를 확인하고 `UN-06`에서 신청 구비서류를 확인한다.
- 네 조합 유형별 문서명, 필수 여부, 발급 주체, 유효기간은 공식 Source에서 확인되지 않아 `UNKNOWN`이다.

## 8. Decision 차이

- 유형 분류 Decision의 존재는 `CONFIRMED`다.
- 네 유형의 판별 조건, 판단 우선순위, 복수 유형 가능 여부와 분기 결과는 `UNKNOWN`이다.
...
- Process 03의 기존 Trigger 외에 개투·벤투·신투·민법별 Trigger를 확인할 공식 근거가 없다.
- 네 유형 모두 유형별 Trigger는 `UNKNOWN`이며 공통 Trigger를 유형별 Rule로 재작성하지 않는다.
...
- PROVISIONAL: 없음
- UNKNOWN: 개투·벤투·신투·민법의 명칭별 구체 차이 전부
- CONFLICT: 없음
