...
**현재 Checkpoint:** `CP-03 — Process Wave 1 QA·배포 완료 / 외부 검토`
...
| 22 | TAP P2 | Process Model Wave 2 생성 | Process Model / 지원 Process | TAP P1-P | PASS | READY | 아니요 | 아니요 | 외부 검토 대기 | 검토 승인 후 지원 Process 7종 생성 |
